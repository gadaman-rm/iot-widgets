const i = (n, o, e, l = !0) => {
  ...
  if (t.setAttribute("id", o.toLowerCase()), t.style.position = "absolute", t.style.width = "15px", t.style.height = "15px", t.style.insetInlineStart = "0px", t.style.insetBlockStart = "0px", t.style.borderRadius = "15px", t.style.transform = `translate(${n.x - 7.5}px, ${n.y - 7.5}px)`, t.style.backgroundColor = e != null && e.color ? e == null ? void 0 : e.color : "green", l === !0) {
