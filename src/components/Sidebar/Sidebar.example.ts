...
<div is="g-sidebar" anchor="left">
  <div class="sidebar-icon" name="toolbox" data-type="menu">
  ...
  <div id="toolbox" class="toolbox" name="toolbox" data-type="panel">
    <h1>Panel Content</h1>
  </div>
</div>
`
const elem = document.querySelector<Sidebar>(`div[is="g-sidebar"]`)!
