...
export class RandomDiv {
    static create({ x = 0, y = 0, width = 100, height = 100, color = 'black', rotate = 0, scaleX = 1, scaleY = 1 }: Create) {
...
export class RandomSvgRect {
    static create({ x = 0, y = 0, width = 100, height = 100, color = 'black', rotate = 0, scaleX = 1, scaleY = 1 }: Create) {
        ...
        rect.setAttribute('transform', `translate(${x}, ${y}) rotate(${rotate}) scale(${scaleX}, ${scaleY})`)
