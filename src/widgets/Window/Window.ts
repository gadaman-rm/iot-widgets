...
export interface WidgetLoadedEvent { loaded: Boolean }
...
export class Window extends HTMLDivElement {
    ...
    constructor() {
        ...
        this.widgetLoadEvent = new CustomEvent<WidgetLoadedEvent>("widget-loaded", { detail: { loaded: false } })
    }
    ...
    idUpdate(oldId: string, newId: string) { console.log("id:", oldId, newId) }
